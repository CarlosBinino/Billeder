...
### Windows:
```
set MONGO_URL=mongodb://backend:7913@ds035036.mlab.com:35036/player_info
meteor
```
### Linux:

```
MONGO_URL="mongodb://backend:7913@ds035036.mlab.com:35036/player_info" meteor
```

### Deploy to galaxy
```
DEPLOY_HOSTNAME=galaxy.meteor.com meteor deploy a2base.meteorapp.com --settings settings.json
```
